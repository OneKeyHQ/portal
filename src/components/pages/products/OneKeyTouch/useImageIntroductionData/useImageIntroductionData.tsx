  ...
  const items = [
    {
      ...
      frames: [
        ...new Array(70)
          ...
          .map((_, i) =>
            staticAssetPrefix(
              `/720-onekey-touch-feature-01/onekey-touch-feature-01_${i
                .toString()
                .padStart(4, '0')}.webp`,
            ),
          ),
    ...
    },
    {
      ...
      frames: [
        ...new Array(60)
          ...
          .map((_, i) =>
            staticAssetPrefix(
              `/720-onekey-touch-feature-02/onekey-touch-feature-02_${i
                .toString()
                .padStart(4, '0')}.webp`,
            ),
          ),
    ...
    },
    {
      ...
      frames: [
        ...new Array(60)
          ...
          .map((_, i) =>
            staticAssetPrefix(
              `/720-onekey-touch-feature-03/onekey-touch-feature-03_${i
                .toString()
                .padStart(4, '0')}.webp`,
            ),
          ),
